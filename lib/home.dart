          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Center(
              child: Container(
                width: 246,
                height:
                    140, // Increased height to accommodate text below images
                 ...
                 padding: const EdgeInsets.symmetric(horizontal: 18), 
                  child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(
                            height: 20), // Add some space between containers
                        Container(
                          width: 410,
                          height: 80,
                          padding: const EdgeInsets.all(16),
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: const BoxDecoration(
                                            image: DecorationImage(
                                              image: AssetImage(
                                                  'assets/images/image3.png'), // Change to your image path
                                              fit: BoxFit.fill,
                                            ),
                                          ),
                                        ),
                        ...
                        const SizedBox(height: 36), // Added SizedBox for spacing
                        Container(
                          width: 410,
                          height: 90,
